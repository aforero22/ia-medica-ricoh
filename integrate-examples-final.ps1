# Script para integrar ejemplos clinicos en la base de datos CIE-10 original
Write-Host "=== Integrando Ejemplos Clinicos en Base de Datos CIE-10 ==="

# Ruta de la base de datos original
$dbPath = "medical-service-advanced/data/cie10_es_database.json"
...
Write-Host "Cargando base de datos original..."
...
foreach ($codigo in $ejemplosClinicos.Keys) {
    ...
    if ($cie10Database.codigos.PSObject.Properties.Name -contains $categoria) {
        # Agregar el codigo con ejemplos clinicos
        $cie10Database.codigos.$categoria.subcategorias.$codigo = $ejemplo.descripcion
...
Write-Host "Total de codigos en base de datos: $($cie10Database.codigos.PSObject.Properties.Name.Count)"
