# Script para crear base de datos expandida con ejemplos clínicos
Write-Host "=== Creando Base de Datos Expandida CIE-10-ES ==="
...
Write-Host "3. Cambia la ruta del archivo a:"
Write-Host "   'data/official/cie10_expanded_database.json'"
Write-Host ""
Write-Host "=== Para obtener la base de datos COMPLETA oficial ==="
Write-Host "1. Visita: https://eciemaps.mscbs.gob.es/ecieMaps/browser/index_10_mc.html"
Write-Host "2. Descarga los datos en formato JSON o CSV"
Write-Host "3. Convierte los datos al formato requerido por la aplicacion" 